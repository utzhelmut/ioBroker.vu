...
gulp.task('rename', function ()  {
    var newname;
    var author = 'Helmut Utz';
    var email  = 'helmut.utz@o2online.de';
    ...
    if (!newname) {
        console.log('Please write the new vu name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/vu.png')) {
        fs.renameSync(__dirname + '/admin/vu.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/vu.html')) {
        fs.renameSync(__dirname + '/widgets/vu.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/vu/js/vu.js')) {
        fs.renameSync(__dirname + '/widgets/vu/js/vu.js', __dirname + '/widgets/vu/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/vu')) {
        fs.renameSync(__dirname + '/widgets/vu',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /vu/g,
        ...
        {
            match: /Vu/g,
            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Vu'
        },
        {
            match: /Helmut Utz/g,
            replacement: author
        ...
        {
            match: /helmut.utz@o2online.de/g,
            replacement: email
        }
    ];
    var files = [
